...
export default (state = initialState, action) => {
  switch (action.type) {
    ...
    case Actions.LoadAll.SUCCESS: {
      ...
      if (meta) {
        newMeta = {
          ...meta,
          currentPage:
            !infiniteScroll || isNewParams || meta.currentPage > stateCurrentPage ? meta.currentPage : stateCurrentPage
        };
      }
    ...
    case Actions.LoadInfo.SUCCESS: {
      const { entity, name, items } = action.payload;
